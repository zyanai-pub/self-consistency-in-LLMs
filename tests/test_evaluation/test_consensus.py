...
def test_get_majority_vote_tie_broken_by_confidence_score(consensus_manager):
    paths = [
        {"extracted_answer": "A", "confidence": 0.8},
        {"extracted_answer": "A", "confidence": 0.6}, # Average A: 0.7
        {"extracted_answer": "B", "confidence": 0.9},
        {"extracted_answer": "B", "confidence": 0.9}  # Average B: 0.9
    ]
...
def test_get_majority_vote_tie_with_negative_confidence_scores(consensus_manager):
    paths = [
        {"extracted_answer": "A", "confidence": -1.5},
        {"extracted_answer": "A", "confidence": -0.5},
        {"extracted_answer": "B", "confidence": -2.0},
        {"extracted_answer": "B", "confidence": -3.0}
    ]
    assert consensus_manager.get_majority_vote(paths) == "A"